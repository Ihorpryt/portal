...
<style>
    .svelte-select {
        ...
        --selectItemFontWeight: var(--selected-item-font-weight);
    ...
    * {
    ...
    :global(body.dark-mode) .svelte-select:hover {
    ...
    .selected-item {
        ...
        font-size: var(--font-size, 16px);
        font-weight: var(--selected-item-font-weight, 400);
    }
    :global(body.dark-mode) .selected-item {
        color: white;
    }
